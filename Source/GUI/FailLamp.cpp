...
void FailLamp::paint(juce::Graphics& g)
{
    ...
    if (displayedLevel > 0.01f)
    {
        ...
        glow.addColour(0.2, Colour::ledRedCore.withAlpha(displayedLevel * 0.57f));
        glow.addColour(0.4, Colour::ledRedCore.withAlpha(displayedLevel * 0.28f));
        glow.addColour(0.6, Colour::ledRedCore.withAlpha(displayedLevel * 0.10f));
        glow.addColour(0.8, Colour::ledRedCore.withAlpha(displayedLevel * 0.02f));
