...
public:
    ...
    void runTest() override
    {
        ...
        beginTest("defaultFactoryProgramIndex actually names \"WARM CASSETTE\"");
        {
            expectEquals(juce::String(kFactoryPrograms[defaultFactoryProgramIndex].name), juce::String("WARM CASSETTE"));
        }
